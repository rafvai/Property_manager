        ...
        try:
            ...
            if save_path:
                ...
                QMessageBox.information(
                    self,
                    "✅ Successo",
                    f"Template generato con successo!\n\n"
                    f"Apri il file, compila le transazioni seguendo le istruzioni,\n"
                    f"e poi importalo usando il pulsante 'Seleziona File'."
                )
